...
class DataGenerator(object):
    ...
    def __init__(self, max_len, quants=quantifiers.get_all_quantifiers(),
                 ...
                 bin_size=1e6, num_data_points=100000, append_padding=True):
        assert(max_len > 1)

        self._max_len = max_len - (1 if append_padding else 0)
        self._max_padding_len = max_len
    ...
    def _generate_sequences(self):
        ...
        for n in xrange(1, self._max_len + 1):
            ...
            data_n = ((seq, quant) for seq in seqs
                      for quant in xrange(num_quants))
    ...
    def _point_from_tuple(self, tup):
        ...
        Args:
            tup: a pair, the first element of which is a tuple of
                    ...
                    range(num_quants)
            padding : boolean value indicating padding up to max_len
        ...
        padded_seq = (chars +
                      ...
                      * (self._max_padding_len  - len(chars)))
    ...
    def _generate_labeled_data(self, num_data_points, balanced=True):
        ...
        total_possible = self._num_quants*sum(
            ...
            for i in xrange(1, self._max_len+1))
    ...
    def write_labeled_data(self, file_path, num_files=256):
        ...
        train_input_filenames = ['{}train_input_{}.txt'.format(file_path, idx)
                                 for idx in xrange(num_train_bins)]
